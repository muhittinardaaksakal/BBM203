...
private:
    ...
    int honour = 1000;
    std::string currentIsleName = "";// Honour player holds, if 0 player should be eracted from the rankings
public:
    ...
    const std::string& getCurrentIsleName() const; // Yeni getter
    void setCurrentIsleName(const std::string& isleName); // Yeni sette
