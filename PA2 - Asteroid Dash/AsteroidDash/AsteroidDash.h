...
#include "Player.h"
#include "Projectile.h"  // Ensure that the Projectile class header is included
...
public:
    ...
    // List to store projectiles (bullets)
    ...
    void shoot();  // Declare shoot as part of the class
};
