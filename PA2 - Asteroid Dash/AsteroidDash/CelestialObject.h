...
public:
    ...
    // Pointer to the next celestial object in the listx
    ...
    // Flag to indicate if the celestial object is visible on the grid
    ...
    static vector<vector<bool>> rotate_90_clockwise(const vector<vector<bool>> &shape);
